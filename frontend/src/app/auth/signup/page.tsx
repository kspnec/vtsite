...
import { signup, CurrentStatus } from "@/lib/api";
      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
        <div className="text-center animate-fade-in max-w-md">
          ...
          <p className="text-gray-500 mb-6">
            Your profile is now pending admin approval. You&apos;ll be able to sign in once approved.
          </p>
          <Link
            href="/"
            className="inline-block bg-green-600 text-white font-semibold px-6 py-2.5 rounded-xl hover:bg-green-700 transition-colors"
          >
            Go back home
          </Link>
        </div>

import enum
from sqlalchemy import Column, DateTime, Date, Enum, ForeignKey, Integer, String, Table, Text
...
class Event(Base):
    ...
    attendees = relationship("User", secondary=event_attendees, backref="attending_events")
